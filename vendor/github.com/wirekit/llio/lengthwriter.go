...
func NewDynamicLengthWriter(w io.Writer, size int, initialLength int) *DynamicLengthWriter {
	var area []byte
	...
	buff := bytespool.Get(initialLength)
	buff.Truncate(0)
